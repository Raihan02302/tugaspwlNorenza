...
class TweetModel extends Model
{
    ...
    protected $allowedFields = [
        'user_id', 'content', 'category', 'like', 'uphoto'
    ];
    ...
    public function newTweet($curUser, $post)
    {
        ...
        $tweet->uphoto = $post['uphoto'];
        $this->save($tweet);
    }
    public function getLatest()
    {
        $query = $this->select('tweets.id, user_id, username, fullname, content, category, created_at, uphoto, tweets.like')
